...
const config = {
  title: 'Dynamic Asset Generator Docs',
  //tagline: 'Dinosaurs are cool',
  //favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://pages.lukebemish.dev',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        style: 'dark',
        copyright: `Copyright © ${new Date().getFullYear()} Luke Bemish and contributors.`,
      },
      prism: {
