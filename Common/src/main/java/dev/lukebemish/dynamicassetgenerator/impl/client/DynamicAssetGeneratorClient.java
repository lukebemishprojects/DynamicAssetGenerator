    ...
    private static void testing() {
        ...
        if (test != null && test.equals("true")) {
            ...
            ASSET_CACHE.planSource(new TextureGenerator(new ResourceLocation("block/end_stone"),
                    new ForegroundTransferSource.Builder().setBackground(new TextureReaderSource.Builder().setPath(new ResourceLocation("block/stone")).build()).setFull(new TextureReaderSource.Builder().setPath(new ResourceLocation("block/redstone_ore")).build()).setNewBackground(new TextureReaderSource.Builder().setPath(new ResourceLocation("block/end_stone")).build()).setExtendPaletteSize(paletteExtend).setTrimTrailing(true).setForceNeighbors(true).setFillHoles(true).setCloseCutoff(defaultLowCutoff).build()));
            ASSET_CACHE.planSource(new TextureGenerator(new ResourceLocation("block/diorite"),
                    new ForegroundTransferSource.Builder().setBackground(new TextureReaderSource.Builder().setPath(new ResourceLocation("block/stone")).build()).setFull(new TextureReaderSource.Builder().setPath(new ResourceLocation("block/coal_ore")).build()).setNewBackground(new TextureReaderSource.Builder().setPath(new ResourceLocation("block/stone")).build()).setExtendPaletteSize(paletteExtend).setTrimTrailing(true).setForceNeighbors(true).setFillHoles(true).setCloseCutoff(defaultLowCutoff).build()));
            ASSET_CACHE.planSource(new TextureGenerator(new ResourceLocation("block/tuff"),
                    new ForegroundTransferSource.Builder().setBackground(new TextureReaderSource.Builder().setPath(new ResourceLocation("block/stone")).build()).setFull(new TextureReaderSource.Builder().setPath(new ResourceLocation("block/coal_ore")).build()).setNewBackground(new TextureReaderSource.Builder().setPath(new ResourceLocation("block/end_stone")).build()).setExtendPaletteSize(paletteExtend).setTrimTrailing(true).setForceNeighbors(true).setFillHoles(true).setCloseCutoff(defaultLowCutoff).build()));
            ASSET_CACHE.planSource(new TextureGenerator(new ResourceLocation("block/calcite"),
                    new ForegroundTransferSource.Builder().setBackground(new TextureReaderSource.Builder().setPath(new ResourceLocation("block/stone")).build()).setFull(new TextureReaderSource.Builder().setPath(new ResourceLocation("block/iron_ore")).build()).setNewBackground(new TextureReaderSource.Builder().setPath(new ResourceLocation("block/end_stone")).build()).setExtendPaletteSize(paletteExtend).setTrimTrailing(true).setForceNeighbors(true).setFillHoles(true).setCloseCutoff(defaultLowCutoff).build()));
